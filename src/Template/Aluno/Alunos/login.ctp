<div class="row">
    <br><br><br><br><br>
    <h4 class="text-center">SISTEMA DE ELETIVAS EEMTI C.F.O.</h4>
    <div class="col-md-3"></div>
    <div class="col-md-6">
    <hr>
        <?= $this->Form->create() ?>        
            <div class="form-group">
                <?= $this->Form->control('matricula', ['class' => 'form-control', 'placeholder' => 'Digite sua matrícula', 'label' => 'Matrícula']) ?>
            </div>
            <div class="form-group">
