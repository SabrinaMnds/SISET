    ...
    <body>
        <section>
            ...
            <table width="100%" style="font-size: 14px;">
                ...
                <tr>
                    <td style="font-weight:bold">ALUNO(A): <?= $aluno -> nome = strtoupper($aluno->nome) ?></td>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr style="background-color:lightgreen">
                            ...
                            <td style="text-align:center">
                                <p dir="ltr">DIA DA SEMANA</p>
                            </td>
                            <td style="text-align:center">
                                <p dir="ltr">SEMESTRE</p>
                            </td>
                            </td>
                        </tr>
                        ...
                        <?php $k = 1; foreach($eletivas->inscricoes as $value): ?>
                            ...
                            <td style="text-align:center"><?= $k ?></td>
                                ...
                                <td style="text-align:center"><?= $value->eletiva->dia_da_semana?></td>
                                <td style="text-align:center"><?= $value->eletiva->semestre?></td>
                            </tr>
                        <?php $k++; endforeach; ?>
                    </tbody>
                </table>
