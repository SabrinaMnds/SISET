    ...
    <body>
        <section>
            ...
            <table width="100%" style="font-size: 14px;">
                ...
                <tr>
                <td style="font-weight:bold">SEMESTRE: <?= $eletiva->semestre ?></td>
                <td style="text-align:center;font-weight:bold">DIA DA SEMANA: <?=$eletiva -> dia_da_semana = strtoupper($eletiva->dia_da_semana) ?></td>
