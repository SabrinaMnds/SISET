...
<nav class="form-inline">
        ...
        <div class="form-group mb-2">
            <?= $this->Form->postLink(__('Apagar'),['action' => 'delete', $professor->id],['class' => 'btn btn-danger btn-fill','confirm' => __('Você tem certeza que quer apagar o registro #{0}?', $professor->id)]) ?>
        </div>
        <div class="form-group mb-2">
