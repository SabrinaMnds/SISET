...
try {
    ...
    Configure::write('App.defaultLocale', 'America/Fortaleza');
} catch (\Exception $e) {
    exit($e->getMessage() . "\n");
}
 ...
 */
date_default_timezone_set(Configure::read('App.defaultLocale'));
...
Configure::write('Routing.prefixes', array('professor'));
/*
